...
export class DBRatingDiscount1623325314182 implements MigrationInterface {
    name = 'DBRatingDiscount1623325314182'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `rating` (`userId` varchar(255) NOT NULL, `RestaurantId` varchar(255) NOT NULL, `rating` float NOT NULL DEFAULT '0', PRIMARY KEY (`userId`, `RestaurantId`)) ENGINE=InnoDB");
