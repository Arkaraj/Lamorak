...
export class DBUpdate1622825694992 implements MigrationInterface {
    name = 'DBUpdate1622825694992'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `food` (`Fid` varchar(36) NOT NULL, `name` text NOT NULL, `description` text NOT NULL, `quantity` int NOT NULL DEFAULT '1', `price` float NOT NULL, `restaurantId` varchar(255) NOT NULL, `available` tinyint NOT NULL DEFAULT 1, `userId` varchar(255) NULL, `orderOid` int NULL, PRIMARY KEY (`Fid`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `Lamorak`.`delivery__person` DROP FOREIGN KEY `address`");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `Lamorak`.`delivery__person` ADD CONSTRAINT `address` FOREIGN KEY (`addressAddressid`) REFERENCES `delivery__person`(`DPid`) ON DELETE RESTRICT ON UPDATE RESTRICT");
