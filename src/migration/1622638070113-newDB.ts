...
export class newDB1622638070113 implements MigrationInterface {
    name = 'newDB1622638070113'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `delivery__person` (`DPid` varchar(36) NOT NULL, `name` text NOT NULL, `available` tinyint NOT NULL DEFAULT 1, PRIMARY KEY (`DPid`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `food` (`Fid` varchar(36) NOT NULL, `name` text NOT NULL, `description` text NOT NULL, `quantity` int NOT NULL DEFAULT '1', `price` float NOT NULL, `restaurantId` varchar(255) NOT NULL, `available` tinyint NOT NULL DEFAULT 1, `userId` varchar(255) NULL, `orderId` int NULL, PRIMARY KEY (`Fid`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `food` ADD CONSTRAINT `FK_1b6534b8f7b3ff1d45f4d480341` FOREIGN KEY (`orderId`) REFERENCES `order`(`Oid`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `food` DROP FOREIGN KEY `FK_1b6534b8f7b3ff1d45f4d480341`");
